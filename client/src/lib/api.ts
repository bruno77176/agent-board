...
export interface Epic { id: string; project_id: string; title: string; description?: string; version?: string; status: string; created_at: string; short_id?: string; start_date?: string | null; end_date?: string | null; source_doc?: string | null }
