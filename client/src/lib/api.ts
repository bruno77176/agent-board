...
export interface Story { id: string; feature_id: string; parent_story_id?: string; title: string; description?: string; status: string; priority: string; assigned_agent_id?: string; tags: string[]; estimated_minutes?: number; git_branch?: string; events?: BoardEvent[]; created_at: string }
